            ...
            <div class="my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="relative p-8 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">Ongoing programs
                        </h2>
                        <a href="{{ route('purchase') }}" class="px-3 md:px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-700">
                            <i class='fa fa-tint'></i>
                            <span class="pl-2">View Purchase (PTC)</span>
                        </a>
