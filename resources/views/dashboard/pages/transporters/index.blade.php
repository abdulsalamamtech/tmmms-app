            ...
            <div class="my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="relative p-8 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">Transporters</h2>
                                ...
                                <tr
                                    ...
                                    <th scope="row">
                                        ...
                                        <div scope="row"
                                            ...
                                            <div class="ps-3">
                                                <div class="text-base font-semibold">HULL Transp LTD</div>
                                                <div class="font-normal text-gray-500">info.hulltransports.com</div>
