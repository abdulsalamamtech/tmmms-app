            ...
            <div class="p-6 my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <div class="space-y-3 py-4 px-2">
                    ...
                    <div class="font-semibold flex justify-between items-start border-b px-2">
                        ...
                        <div class="w-7/12 text-gray-500 dark:text-gray-400">1,000,000</div>
                    </div>

                    <div class="font-semibold flex justify-between items-start border-b px-2">
                        <div class="w-1/3 text-gray-700 dark:text-gray-300">Litters Lifted:</div>
                        <div class="w-7/12 text-gray-500 dark:text-gray-400">850,000</div>
                    </div>
            ...
            <div class="my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="relative p-8 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-300">Approved Program</h2>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2"></div> Processing
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                                ...
                                                <div class="grid grid-cols-6 gap-6">
                                                    ...
                                                    <div class="col-span-6 sm:col-span-3">
                                                        ...
                                                        <input type="number" name="first-name" id="first-name"
                                                            ...
                                                            placeholder="July Starter program" required="" value="35000">
                                                    </div>
